    ...
    java = {
      format = {
        settings = {
          ...
          url = "/Users/ctacbarada/Storage/GitHub/Java/Style/eclipse-java-google-style.xml",
          profile = "GoogleStyle",
        },
      },
...
local bundles = {
  -- vim.fn.glob(
  --   "/Users/ctacbarada/.m2/repository/com/microsoft/java/com.microsoft.java.debug.plugin/0.47.0/com.microsoft.java.debug.plugin-*.jar",
  --   1
  -- ),
  vim.fn.glob(
